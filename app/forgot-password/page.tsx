...
export default function ForgotPasswordPage() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      await authApi.forgotPassword({ email: String(form.get('email')) });
