...
const nav = [
  ...
  { key: 'purchase', label: 'Purchase', path: '/purchase', icon: ShoppingCart, section: 'Operations' },
  { key: 'sales', label: 'Sales & Dispatch', path: '/sales', icon: ShoppingCart, section: 'Operations' },
  { key: 'production', label: 'Production', path: '/production/dashboard', icon: Factory, section: 'Operations' },
  { key: 'jobwork', label: 'Job Work', path: '/jobwork/challans', icon: Box, section: 'Operations' },
  { key: 'inventory', label: 'Inventory', path: '/inventory', icon: Package, section: 'Operations' },
  { key: 'quality', label: 'Quality', path: '/quality', icon: FileBarChart, section: 'Operations' },
